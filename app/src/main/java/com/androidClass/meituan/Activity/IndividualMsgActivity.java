...
public class IndividualMsgActivity extends AppCompatActivity {
    ...
    private ImageButton myStarButton;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myStarButton = findViewById(R.id.myStar_Button);
...
//                startActivity(settingsIntent);
    ...
    private void myStarButtonListener() {
        myStarButton.setOnClickListener(v -> {
            // 我的收藏按钮监听
            Intent intent = new Intent(this, MyStarActivity.class);
